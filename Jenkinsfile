        ...
        stage('Update Test Environment') {
            steps {
                ...
                script {
                    ...
                    powershell '$password = "Westcoast6033"; $username = "gordon.marsh@westcoast.co.uk"; $credential = New-Object System.Management.Automation.PSCredential($username,$password);  invoke-command -computer bnwauto01 -filepath "updatedockercontainer.ps1" -Credential $credential'
