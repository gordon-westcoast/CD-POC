        ...
        stage('Update Test Environment') {
            steps {
                ...
                script {
                    ...
                    powershell 'Invoke-Command -ComputerName "bnwci01" -filepath ".\\InstallFiles\\updatedockercontainer.ps1" -AsJob'
                    //powershell 'Invoke-Command -ComputerName "bnwci01" -ScriptBlock { docker login -u dockerwestcoast -p WeStCoAsT123; docker pull dockerwestcoast/pocimage; docker stop opg1; docker rm opg1; docker run -p 8080:8080 --name opg1 -d dockerwestcoast/pocimage }'                 
                }
